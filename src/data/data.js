const data = [
  ...
  },
  {
    ...
    description:
      "Come discover Paris from this fully equipped studio located at short distance from Buttes Chaumont. Fully equipped for your comfort and elegantly decorated, allowing you to live like a Parisian for the duration of your stay.",
    host: {
      name: "Franck Maher",
      picture:
  ...
  },
  {
    ...
    tags: ["Parmentier", "Marais", "Park", "Night Life"],
  },
  {
    id: "0979876d",
    ...
    tags: ["Goncourt", "Close to shopping"],
  },
  {
    id: "f72a452f",
  ...
  },
  {
    ...
    tags: ["Transportation", "Budget", "18th arrondissement"],
  },
  {
    id: "bc6f7112",
    ...
    tags: ["Luxurious", "Eiffel Tower", "3 rooms", "6th arrondissement"],
  },
  {
    id: "cb2f9222",
    title: "Family Suite",
    ...
    tags: ["Montparnasse", "Shopping", "Family"],
  },
  {
    id: "d60ca600",
    ...
    tags: ["PÃ¨re Lachaise", "11th arrondissement", "Metro 3", "Metro 2"],
  },
  {
    id: "2cf259e1",
    ...
    description:
      "Located in the heart of the Marais district, our studio is ideal for tourists eager to explore the city. Its fully equipped kitchen is highly practical.",
    host: {
      name: "Victor Moran",
      picture:
  ...
  },
  {
    ...
    description:
      "Trade Paris for lush greenery. Just 30 minutes from Gare du Nord station, experience the Ã‰couen forest from your bungalow window. This fully equipped property provides a comforting welcome, allowing you to focus on what really matters. In the morning, you can open the windows and enjoy the sound of birds singing.",
    host: {
      name: "Sarah Devit",
      picture:
        "https://s3-eu-west-1.amazonaws.com/course.oc-static.com/projects/front-end-kasa-project/profile-picture-8.jpg",
    ...
    tags: ["Forest", "Nature", "Ã‰couen Museum"],
  },
  {
    id: "7cbb378e",
    ...
    tags: ["Forest", "Nature", "Large house"],
  },
  {
    id: "ba55a0cc",
    ...
    description:
      "Five-room house. Perfect for large groups. 45 minutes from Paris Saint-Lazare.",
    host: {
      name: "Karen Guillet",
      picture:
        "https://s3-eu-west-1.amazonaws.com/course.oc-static.com/projects/front-end-kasa-project/profile-picture-9.jpg",
  ...
  },
  {
    ...
    tags: ["View of the park", "Charming apartment"],
  },
  {
    id: "2139a317",
    ...
    description:
      "This room has all the amenities you need. Close to the metro and shopping.",
    host: {
      name: "Hugo Perrier",
      picture:
        "https://s3-eu-west-1.amazonaws.com/course.oc-static.com/projects/front-end-kasa-project/profile-picture-4.jpg",
  ...
  },
  {
    ...
    description:
      "This tastefully decorated studio will be your cozy retreat after a long day exploring the bustling streets of Paris.",
    host: {
      name: "Michel Romy",
      picture:
  ...
  },
  {
    ...
    description:
      "Located in the heart of the historic Marais district, this apartment is ideal for couples exploring Paris. Just five minutes from the Louvre on Rue de Rivoli.",
    host: {
      name: "Nathalie Jean",
      picture:
        "https://s3-eu-west-1.amazonaws.com/course.oc-static.com/projects/front-end-kasa-project/profile-picture-12.jpg",
